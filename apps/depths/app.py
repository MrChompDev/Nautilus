...
TOOLS = [
    ...
    ("cert_search",   "Cert Search",    "Recon",    1,  100,  "\U0001F512",
     "Find subdomains in CT logs",      "cert_search"),
    ...
    ("security_headers","Security Headers","RedTeam",1,120,   "\U0001F513",
     "Grade a site's HTTP security headers", "security_headers"),
